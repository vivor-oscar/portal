    ...
    // Assume student_id and class_name are available in the session or can be fetched
    // For demonstration, let's assume a dummy student ID and class
    $current_student_id = $_SESSION['student_id'] ?? 'S12345'; // Replace with actual session variable
    $current_student_class = $_SESSION['class_name'] ?? 'Grade 10'; // Replace with actual session variable
            ...
            <div class="mt-16"> <!-- Added margin-top for header spacing -->
                <div class="w-full max-w-3xl">
                    <div class="bg-white rounded-xl container-shadow p-6">
                        ...
                        <div class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs sm:text-sm">
